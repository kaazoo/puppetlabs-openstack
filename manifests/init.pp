...
class openstack (
  ...
  $neutron_network_vlan_ranges = ['physnet1:1000:1100'],
  $neutron_physical_interface_mappings = ['physnet1:eth1'],
  ...
  if $use_hiera {
    class { '::openstack::config':
      ...
      neutron_flat_networks         => hiera(openstack::neutron::flat_networks, $neutron_flat_networks),
      neutron_network_vlan_ranges   => hiera(openstack::neutron::network_vlan_ranges, $neutron_network_vlan_ranges),
      neutron_physical_interface_mappings => hiera(openstack::neutron::physical_interface_mappings, $neutron_physical_interface_mappings),
